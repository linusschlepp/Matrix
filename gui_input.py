...
class Window:
    ...
    def __init__(self, win):
        ...
        btn = Button(win, text='Solve Matrix', fg='blue',
                     command=lambda: self.convert_to_list(self.matrix_list, self.vector_list))
        btn.place(x=80, y=100)
        self.cb_col.bind("<<ComboboxSelected>>",
                         lambda x: self.show_matrix(int(self.cb_row.get()), int(self.cb_col.get())))
